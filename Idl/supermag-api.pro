...
FUNCTION SuperMAGGetInventory,logon,yr,mo,dy,hr,mt,sc,extent,iarr,error=errstr
  ...
  urlstr+='&start='+string(yr,mo,dy,hr,mt, $
           FORMAT='(I4.4,"-",I2.2,"-",I2.2,"T",I2.2,":",I2.2)')
...
FUNCTION SuperMAGGetDataStruct,logon,yr,mo,dy,hr,mt,sc,extent,station,magdata,error=errstr, $
  ...
  if keyword_set(ALL) then urlstr+='&mlt&aacgm&geo&decl&sza' $
  else begin
...
FUNCTION SuperMAGGetDataArray,logon,yr,mo,dy,hr,mt,sc,extent,station,tval,n,e,z,error=errstr, $
...
FUNCTION SuperMAGGetIndicesStruct,logon,yr,mo,dy,hr,mt,sc,extent,inxdata,error=errstr, $
...
FUNCTION SuperMAGGetIndicesArray,logon,yr,mo,dy,hr,mt,sc,extent,tval,error=errstr, $
                                    SME=sme,SML=sml,SMU=smu, $
                                    MLAT=mlat,MLT=mlt,GLAT=glat,GLON=glon,STID=stid,NUM=num, $
                                    SUNSME=sunsme,SUNSML=sunsml,SUNSMU=sunsmu, $
                                    SUNMLAT=sunmlat,SUNMLT=sunmlt,SUNGLAT=sunglat,SUNGLON=sunglon, $
